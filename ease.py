...
class Ease:
    ...
    #############################################################
    @staticmethod
    def in_quad(time_step: float):
        return math.pow(time_step, 2)

    @staticmethod
    def out_quad(time_step: float):
        return 1 - math.pow(1 - time_step, 2)

    @staticmethod
    def in_out_quad(time_step: float):
    ...
    #############################################################
    @staticmethod
    def in_cubic(time_step: float):
        return math.pow(time_step, 3)

    @staticmethod
    def out_cubic(time_step: float):
        return 1 - math.pow(1 - time_step, 3)

    @staticmethod
    def in_out_cubic(time_step: float):
    ...
    #############################################################
    @staticmethod
    def in_quart(time_step: float):
        return math.pow(time_step, 4)

    @staticmethod
    def out_quart(time_step: float):
        return 1 - math.pow(1 - time_step, 4)

    @staticmethod
    def in_out_quart(time_step: float):
    ...
    #############################################################
    @staticmethod
    def in_quint(time_step: float):
        return math.pow(time_step, 5)

    @staticmethod
    def out_quint(time_step: float):
        return 1 - math.pow(1 - time_step, 5)

    @staticmethod
    def in_out_quint(time_step: float):
    ...
    #############################################################
    @staticmethod
    def in_circ(time_step: float):
        return 1 - math.sqrt(1 - math.pow(time_step, 2))

    @staticmethod
    def out_circ(time_step: float):
        return math.sqrt(1 - math.pow(time_step - 1, 2))

    @staticmethod
    def in_out_circ(time_step: float):
    ...
    @staticmethod
    def in_elastic(time_step: float):
        ANGLE = TAU / 3
    ...
    @staticmethod
    def in_out_elastic(time_step: float):
        ANGLE = TAU / 4.5
        if time_step == 0.0 or time_step == 1.0:
            return time_step
        elif time_step < 0.5:
    ...
    @staticmethod
    def in_bounce(time_step: float):
        return 1 - Ease.out_bounce(1 - time_step)

    @staticmethod
    def out_bounce(time_step: float):
        if time_step < (1 / 2.75):
    ...
    @staticmethod
    def in_out_bounce(time_step: float):
